    ...
    return(
        <main className="work-section">
            ...
            <section className="footer-section">
                <p>💌 <a href="mailto:tolanidaniel02@gmail.com" style={{ color: '#2E3840', textDecoration: 'underline' }}>Contact me</a><img alt="heart-gif" src="https://media3.giphy.com/media/v1.Y2lkPTc5MGI3NjExMWI1NTlmY2E4ODk2MDcxNWVhNjg3ZGI4YTA5ZTQ3MWEwYWQyZTQ0MCZjdD1z/L3gknvclvOxoP1jWlm/giphy.gif"/>if you have any questions or would like to discuss potential collaboration opportunities.</p>
            </section>
        </main>
    )
}
